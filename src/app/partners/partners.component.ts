...
@Component({
  ...
  template: `
    <section class="relative py-24 overflow-hidden bg-white">
      ...
      <div class="relative w-full before:absolute before:left-0 before:top-0 before:z-10 before:h-full before:w-[100px] before:bg-gradient-to-r before:from-white before:to-transparent after:absolute after:right-0 after:top-0 after:z-10 after:h-full after:w-[100px] after:bg-gradient-to-l after:from-white after:to-transparent">
        <div class="flex animate-scroll py-8">
  ...
  styles: [
    ...
    @media (max-width: 768px) {
      .animate-scroll {
        animation-duration: 20s; /* Same speed as desktop */
      }
    }
...
export class PartnersComponent implements OnInit {
  partners = [
    { logo: 'https://www.aions.co.za/wp-content/uploads/2022/02/Aions-logo-web.png', url: 'https://www.aions.co.za' },
    ...
    { logo: 'https://w7.pngwing.com/pngs/265/381/png-transparent-xero-accounting-software-accountant-bookkeeping-business-blue-text-people.png', url: 'https://www.xero.com/za/' },
    { logo: 'https://b6k3m2b2.delivery.rocketcdn.me/wp-content/uploads/2022/07/Zwane-Financial-3D-Logo-with-Shadow-Angle0-300x300.png', url: 'https://www.zwanefin.co.za/' },
